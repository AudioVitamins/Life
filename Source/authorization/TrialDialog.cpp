...
void SeqTrialDialog::enableDisable()
{
   ...
   case lockedWithFailure:
      ...
      if (mState == emailFailed) {
         txt = mLastError +". Please visit " SEQ_TRIAL_URL_FRIENDLY " to get a " BETA_TRIAL " code.";
      }
         ...
         txt += "If you have purchased Life, click Registration to enter your registration details.\n"
            "To try Life, enter a valid email address to have a trial code "
            "delivered by email. If you already have a trial code, enter it in "
            "the space provided. "
...
#define SBTITLE "Unregistered Version of Life"
   ...
   mLblTitle->setFont(Font(20.0f, Font::bold));
