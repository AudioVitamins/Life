...
key validate:
   ...
   */
   ...
   if (gota && gotb) {
      ...
      mState = trial;
      txt = 
         "If you are licensed to use the software, please enter your purchase id "
         "and code below and click 'Authorize Now'. If you are not online, "
...
SeqAuthDialog::SeqAuthDialog(SeqGlob * glob, CptNotify * parent) : 
   SeqModalDialog(glob, SEQCTL_AUTHDIALOG, parent, 400, 200) {
